...
GEOTIFF_DIR = REFERENCE_DATA_ROOT / "daytona" / "Jacksonville_geotiff"
GEOTIFF_PATH = GEOTIFF_DIR / "Jacksonville SEC.tif"
WORLD_FILE_PATH = GEOTIFF_DIR / "Jacksonville SEC.tfw"
DISPLAY_CACHE_PATH = GEOTIFF_DIR / "Jacksonville SEC.display_3330.png"
DISPLAY_MAX_WIDTH = 3330
# Tight crop of the actual chart face within the Jacksonville sectional display.
# Keep the central Florida map area, but exclude the descriptive/footer strip
# below the map. Future added sections should define a face box like this rather
# than using the full rendered chart image.
MAP_FACE_DISPLAY_BOX = (0, 0, 3330, 2232)
...
def _build_projection() -> dict[str, float]:
    if not has_chart():
        raise RuntimeError("Daytona/Jacksonville GeoTIFF files are missing")
